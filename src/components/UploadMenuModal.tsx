    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-50 w-[92%] max-w-lg bg-white rounded-xl shadow-xl">
        ...
        <div className="flex items-start justify-between px-6 py-4 border-b border-gray-100">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 items-start">Create New Menu</h3>
            <p className="text-sm text-gray-500 mt-1 text-start">
              Upload single or multiple menus. We’ll generate a single QR code that directs customers accordingly.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-5 relative">
          ...
          {/* footer / actions */}
          <div className="flex mt-5 items-center justify-end gap-3 px-1 py-4 border-t border-gray-100">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              type="submit"
              disabled={isSaving}
              className={`px-5 py-2 rounded-md text-white text-sm transition ${isSaving ? "bg-gray-400 cursor-not-allowed" : "bg-[#5C2E1E] hover:bg-[#4a261a]"}`}
            >
