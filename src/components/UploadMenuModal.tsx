...
export default function UploadMenuModal({ onClose }: UploadMenuModalProps) {
    ...
    return (
      ...
      />
                        ...
                        {file ? (
                            ...
                            <label onClick={() => fileInputRef.current?.click()} className="border border-dashed border-gray-300 rounded-md px-4 py-8 text-center block cursor-pointer hover:bg-gray-50 transition">
                                <input
                                    type="file"
                                    accept=".pdf,.jpg,.png"
                                    onChange={handleFileChange}
